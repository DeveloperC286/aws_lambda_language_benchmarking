resource "aws_api_gateway_rest_api" "api_gateway_python3_128_mb" {
  name = "api_gateway_python3_128_mb"
}

resource "aws_api_gateway_resource" "api_gateway_python3_128_mb_resource" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway_python3_128_mb.id
  parent_id   = aws_api_gateway_rest_api.api_gateway_python3_128_mb.root_resource_id
  path_part   = "hash"
}
...
resource "aws_lambda_permission" "api_gateway_python3_128_mb_permission" {
  ...
  source_arn    = "${aws_api_gateway_rest_api.api_gateway_python3_128_mb.execution_arn}/*/*"

  depends_on = [aws_lambda_function.python3_128_mb, aws_api_gateway_rest_api.api_gateway_python3_128_mb]
}

resource "aws_api_gateway_deployment" "api_gateway_python3_128_mb_production" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway_python3_128_mb.id
  stage_name  = "production"

  depends_on = [aws_api_gateway_integration.api_gateway_python3_128_mb_integration]
}
